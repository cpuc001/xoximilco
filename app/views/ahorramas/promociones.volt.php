...
<script id="loadcss">loadCSS( "<?= $this->url->get('assets/output/css/main.min.css') ?>", document.getElementById("loadcss") );</script>
	...
	<nav>
        ...
        <?php $v139739999540154969601iterator = $t->promociones->items; $v139739999540154969601incr = 0; $v139739999540154969601loop = new stdClass(); $v139739999540154969601loop->self = &$v139739999540154969601loop; $v139739999540154969601loop->length = count($v139739999540154969601iterator); $v139739999540154969601loop->index = 1; $v139739999540154969601loop->index0 = 1; $v139739999540154969601loop->revindex = $v139739999540154969601loop->length; $v139739999540154969601loop->revindex0 = $v139739999540154969601loop->length - 1; ?><?php foreach ($v139739999540154969601iterator as $promocion) { ?><?php $v139739999540154969601loop->first = ($v139739999540154969601incr == 0); $v139739999540154969601loop->index = $v139739999540154969601incr + 1; $v139739999540154969601loop->index0 = $v139739999540154969601incr; $v139739999540154969601loop->revindex = $v139739999540154969601loop->length - $v139739999540154969601incr; $v139739999540154969601loop->revindex0 = $v139739999540154969601loop->length - ($v139739999540154969601incr + 1); $v139739999540154969601loop->last = ($v139739999540154969601incr == ($v139739999540154969601loop->length - 1)); ?>
            <?php $this->partial('templates/_molecules/promoItem', ['item' => $promocion, 'button' => $t->promociones->button, 'position' => 'Promociones - ' . $v139739999540154969601loop->index]); ?>
	...
	<?php } ?>
        ...
        <footer>
                ...
                <?php $this->_macros['attributes'] = function($__p = null) { if (isset($__p[0])) { $data = $__p[0]; } else { if (isset($__p["data"])) { $data = $__p["data"]; } else {  throw new \Phalcon\Mvc\View\Exception("Macro 'attributes' was called without parameter: data");  } }  ?><?php $v139739999540154969601iterator = $data; $v139739999540154969601incr = 0; $v139739999540154969601loop = new stdClass(); $v139739999540154969601loop->self = &$v139739999540154969601loop; $v139739999540154969601loop->length = count($v139739999540154969601iterator); $v139739999540154969601loop->index = 1; $v139739999540154969601loop->index0 = 1; $v139739999540154969601loop->revindex = $v139739999540154969601loop->length; $v139739999540154969601loop->revindex0 = $v139739999540154969601loop->length - 1; ?><?php foreach ($v139739999540154969601iterator as $attribute => $value) { ?><?php $v139739999540154969601loop->first = ($v139739999540154969601incr == 0); $v139739999540154969601loop->index = $v139739999540154969601incr + 1; $v139739999540154969601loop->index0 = $v139739999540154969601incr; $v139739999540154969601loop->revindex = $v139739999540154969601loop->length - $v139739999540154969601incr; $v139739999540154969601loop->revindex0 = $v139739999540154969601loop->length - ($v139739999540154969601incr + 1); $v139739999540154969601loop->last = ($v139739999540154969601incr == ($v139739999540154969601loop->length - 1)); ?>
		<?= $attribute ?><?php if (($value != '')) { ?>
			="<?= $value ?>"<?php } ?>
		<?= ' ' ?><?php $v139739999540154969601incr++; } ?><?php }; $this->_macros['attributes'] = \Closure::bind($this->_macros['attributes'], $this); ?><?php $this->_macros['schema'] = function($__p = null) { if (isset($__p[0])) { $data = $__p[0]; } else { if (isset($__p["data"])) { $data = $__p["data"]; } else {  throw new \Phalcon\Mvc\View\Exception("Macro 'schema' was called without parameter: data");  } }  ?>
	<<?= $data->tag ?>  <?php if (isset($data->attributes)) { ?> <?= $this->callMacro('attributes', [$data->attributes]) ?> <?php } ?> >
	<?php if (isset($data->text)) { ?>
		<?= $data->text ?>
	<?php } ?>
	<?php if (isset($data->items)) { ?><?php $v139739999540154969601iterator = $data->items; $v139739999540154969601incr = 0; $v139739999540154969601loop = new stdClass(); $v139739999540154969601loop->self = &$v139739999540154969601loop; $v139739999540154969601loop->length = count($v139739999540154969601iterator); $v139739999540154969601loop->index = 1; $v139739999540154969601loop->index0 = 1; $v139739999540154969601loop->revindex = $v139739999540154969601loop->length; $v139739999540154969601loop->revindex0 = $v139739999540154969601loop->length - 1; ?><?php foreach ($v139739999540154969601iterator as $item) { ?><?php $v139739999540154969601loop->first = ($v139739999540154969601incr == 0); $v139739999540154969601loop->index = $v139739999540154969601incr + 1; $v139739999540154969601loop->index0 = $v139739999540154969601incr; $v139739999540154969601loop->revindex = $v139739999540154969601loop->length - $v139739999540154969601incr; $v139739999540154969601loop->revindex0 = $v139739999540154969601loop->length - ($v139739999540154969601incr + 1); $v139739999540154969601loop->last = ($v139739999540154969601incr == ($v139739999540154969601loop->length - 1)); ?>
			<?= $this->callMacro('schema', [$item]) . ' ' ?><?php $v139739999540154969601incr++; } ?>
	<?php } ?>
...
<div class="upperfooter">
    <div class="container">
        <div class="parks">
            <?php $v139739999540154969601iterator = $g->footer->logos; $v139739999540154969601incr = 0; $v139739999540154969601loop = new stdClass(); $v139739999540154969601loop->self = &$v139739999540154969601loop; $v139739999540154969601loop->length = count($v139739999540154969601iterator); $v139739999540154969601loop->index = 1; $v139739999540154969601loop->index0 = 1; $v139739999540154969601loop->revindex = $v139739999540154969601loop->length; $v139739999540154969601loop->revindex0 = $v139739999540154969601loop->length - 1; ?><?php foreach ($v139739999540154969601iterator as $logo) { ?><?php $v139739999540154969601loop->first = ($v139739999540154969601incr == 0); $v139739999540154969601loop->index = $v139739999540154969601incr + 1; $v139739999540154969601loop->index0 = $v139739999540154969601incr; $v139739999540154969601loop->revindex = $v139739999540154969601loop->length - $v139739999540154969601incr; $v139739999540154969601loop->revindex0 = $v139739999540154969601loop->length - ($v139739999540154969601incr + 1); $v139739999540154969601loop->last = ($v139739999540154969601incr == ($v139739999540154969601loop->length - 1)); ?>
        ...
        <?php if (!$desktop) { ?>
            <div class="social u-cf">
                <ul class="nav nav--inline nav-icon">
                    <?php $v139739999540154969601iterator = $g->social; $v139739999540154969601incr = 0; $v139739999540154969601loop = new stdClass(); $v139739999540154969601loop->self = &$v139739999540154969601loop; $v139739999540154969601loop->length = count($v139739999540154969601iterator); $v139739999540154969601loop->index = 1; $v139739999540154969601loop->index0 = 1; $v139739999540154969601loop->revindex = $v139739999540154969601loop->length; $v139739999540154969601loop->revindex0 = $v139739999540154969601loop->length - 1; ?><?php foreach ($v139739999540154969601iterator as $social) { ?><?php $v139739999540154969601loop->first = ($v139739999540154969601incr == 0); $v139739999540154969601loop->index = $v139739999540154969601incr + 1; $v139739999540154969601loop->index0 = $v139739999540154969601incr; $v139739999540154969601loop->revindex = $v139739999540154969601loop->length - $v139739999540154969601incr; $v139739999540154969601loop->revindex0 = $v139739999540154969601loop->length - ($v139739999540154969601incr + 1); $v139739999540154969601loop->last = ($v139739999540154969601incr == ($v139739999540154969601loop->length - 1)); ?>
            ...
            <div class="accordion--item is_close">
                ...
                <div class="accordion-content">
                    <div class="flex--wrap" data-items="<?php if ($mobile) { ?>2<?php } else { ?>3<?php } ?>">
                        <?php $v139739999540154969601iterator = $g->footer->superior->principal; $v139739999540154969601incr = 0; $v139739999540154969601loop = new stdClass(); $v139739999540154969601loop->self = &$v139739999540154969601loop; $v139739999540154969601loop->length = count($v139739999540154969601iterator); $v139739999540154969601loop->index = 1; $v139739999540154969601loop->index0 = 1; $v139739999540154969601loop->revindex = $v139739999540154969601loop->length; $v139739999540154969601loop->revindex0 = $v139739999540154969601loop->length - 1; ?><?php foreach ($v139739999540154969601iterator as $seccion) { ?><?php $v139739999540154969601loop->first = ($v139739999540154969601incr == 0); $v139739999540154969601loop->index = $v139739999540154969601incr + 1; $v139739999540154969601loop->index0 = $v139739999540154969601incr; $v139739999540154969601loop->revindex = $v139739999540154969601loop->length - $v139739999540154969601incr; $v139739999540154969601loop->revindex0 = $v139739999540154969601loop->length - ($v139739999540154969601incr + 1); $v139739999540154969601loop->last = ($v139739999540154969601incr == ($v139739999540154969601loop->length - 1)); ?>
                        <div class="flex--item">
                            <h5><?= $seccion->title ?></h5>
                    ...
                    <ul class="list list-columns list-bars <?= ($mobile ? 'list-mobile' : '') ?>">
                        <?php $v139739999540154969601iterator = $g->footer->superior->secundario; $v139739999540154969601incr = 0; $v139739999540154969601loop = new stdClass(); $v139739999540154969601loop->self = &$v139739999540154969601loop; $v139739999540154969601loop->length = count($v139739999540154969601iterator); $v139739999540154969601loop->index = 1; $v139739999540154969601loop->index0 = 1; $v139739999540154969601loop->revindex = $v139739999540154969601loop->length; $v139739999540154969601loop->revindex0 = $v139739999540154969601loop->length - 1; ?><?php foreach ($v139739999540154969601iterator as $link) { ?><?php $v139739999540154969601loop->first = ($v139739999540154969601incr == 0); $v139739999540154969601loop->index = $v139739999540154969601incr + 1; $v139739999540154969601loop->index0 = $v139739999540154969601incr; $v139739999540154969601loop->revindex = $v139739999540154969601loop->length - $v139739999540154969601incr; $v139739999540154969601loop->revindex0 = $v139739999540154969601loop->length - ($v139739999540154969601incr + 1); $v139739999540154969601loop->last = ($v139739999540154969601incr == ($v139739999540154969601loop->length - 1)); ?>
                            <li>
            ...
            <div class="accordion--item is_close">
                ...
                <div class="accordion-content">
                    ...
                    <ul class="list list-columns phones" data-column="3">
                        <?php $v139739999540154969601iterator = $g->header->atencion->sub; $v139739999540154969601incr = 0; $v139739999540154969601loop = new stdClass(); $v139739999540154969601loop->self = &$v139739999540154969601loop; $v139739999540154969601loop->length = count($v139739999540154969601iterator); $v139739999540154969601loop->index = 1; $v139739999540154969601loop->index0 = 1; $v139739999540154969601loop->revindex = $v139739999540154969601loop->length; $v139739999540154969601loop->revindex0 = $v139739999540154969601loop->length - 1; ?><?php foreach ($v139739999540154969601iterator as $s) { ?><?php $v139739999540154969601loop->first = ($v139739999540154969601incr == 0); $v139739999540154969601loop->index = $v139739999540154969601incr + 1; $v139739999540154969601loop->index0 = $v139739999540154969601incr; $v139739999540154969601loop->revindex = $v139739999540154969601loop->length - $v139739999540154969601incr; $v139739999540154969601loop->revindex0 = $v139739999540154969601loop->length - ($v139739999540154969601incr + 1); $v139739999540154969601loop->last = ($v139739999540154969601incr == ($v139739999540154969601loop->length - 1)); ?>
