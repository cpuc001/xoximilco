...
<script id="loadcss">loadCSS( "<?= $this->url->get('assets/output/css/main.min.css') ?>", document.getElementById("loadcss") );</script>
	...
	<nav>
        ...
        <?php $v17688440650096070881iterator = $g->nav->desktop->main; $v17688440650096070881incr = 0; $v17688440650096070881loop = new stdClass(); $v17688440650096070881loop->self = &$v17688440650096070881loop; $v17688440650096070881loop->length = count($v17688440650096070881iterator); $v17688440650096070881loop->index = 1; $v17688440650096070881loop->index0 = 1; $v17688440650096070881loop->revindex = $v17688440650096070881loop->length; $v17688440650096070881loop->revindex0 = $v17688440650096070881loop->length - 1; ?><?php foreach ($v17688440650096070881iterator as $menu) { ?><?php $v17688440650096070881loop->first = ($v17688440650096070881incr == 0); $v17688440650096070881loop->index = $v17688440650096070881incr + 1; $v17688440650096070881loop->index0 = $v17688440650096070881incr; $v17688440650096070881loop->revindex = $v17688440650096070881loop->length - $v17688440650096070881incr; $v17688440650096070881loop->revindex0 = $v17688440650096070881loop->length - ($v17688440650096070881incr + 1); $v17688440650096070881loop->last = ($v17688440650096070881incr == ($v17688440650096070881loop->length - 1)); ?>
            <?php if (!$v17688440650096070881loop->first) { ?>
                <?php if (isset($menu->submenus)) { ?>
                    <h4><?= $menu->menu ?></h4>
                    <ul>
                    <?php foreach ($menu->submenus as $submenu) { ?>
                        <li>
                            <a href="<?= $this->url->get($lang . '/' . $submenu->href) ?>"><?= $submenu->menu ?></a>
                        </li>
                    <?php } ?>
                    </ul>
                <?php } else { ?>
                    <h4><a href="<?= $this->url->get($lang . '/' . $menu->href) ?>"><?= $menu->menu ?></a></h4>
                <?php } ?>
            <?php } ?>
        <?php $v17688440650096070881incr++; } ?>
        <h2>Footer</h2>
        <?php $v17688440650096070881iterator = $g->footer->superior->principal; $v17688440650096070881incr = 0; $v17688440650096070881loop = new stdClass(); $v17688440650096070881loop->self = &$v17688440650096070881loop; $v17688440650096070881loop->length = count($v17688440650096070881iterator); $v17688440650096070881loop->index = 1; $v17688440650096070881loop->index0 = 1; $v17688440650096070881loop->revindex = $v17688440650096070881loop->length; $v17688440650096070881loop->revindex0 = $v17688440650096070881loop->length - 1; ?><?php foreach ($v17688440650096070881iterator as $seccion_footer) { ?><?php $v17688440650096070881loop->first = ($v17688440650096070881incr == 0); $v17688440650096070881loop->index = $v17688440650096070881incr + 1; $v17688440650096070881loop->index0 = $v17688440650096070881incr; $v17688440650096070881loop->revindex = $v17688440650096070881loop->length - $v17688440650096070881incr; $v17688440650096070881loop->revindex0 = $v17688440650096070881loop->length - ($v17688440650096070881incr + 1); $v17688440650096070881loop->last = ($v17688440650096070881incr == ($v17688440650096070881loop->length - 1)); ?>
            <h4><?= $seccion_footer->title ?></h4>
            <ul>
            <?php foreach ($seccion_footer->links as $link) { ?>
                <li>
                    <a <?= ((isset($link->ext) && $link->ext == true) ? 'href="' . $link->href . '" target="_blank"' : 'href="' . $this->url->get($lang . '/' . $link->href) . '"') ?>>
                        <span><?= $link->text ?></span>
                    </a>
                </li>
            <?php } ?>
        ...
        <footer>
                ...
                <?php $this->_macros['attributes'] = function($__p = null) { if (isset($__p[0])) { $data = $__p[0]; } else { if (isset($__p["data"])) { $data = $__p["data"]; } else {  throw new \Phalcon\Mvc\View\Exception("Macro 'attributes' was called without parameter: data");  } }  ?><?php $v17688440650096070881iterator = $data; $v17688440650096070881incr = 0; $v17688440650096070881loop = new stdClass(); $v17688440650096070881loop->self = &$v17688440650096070881loop; $v17688440650096070881loop->length = count($v17688440650096070881iterator); $v17688440650096070881loop->index = 1; $v17688440650096070881loop->index0 = 1; $v17688440650096070881loop->revindex = $v17688440650096070881loop->length; $v17688440650096070881loop->revindex0 = $v17688440650096070881loop->length - 1; ?><?php foreach ($v17688440650096070881iterator as $attribute => $value) { ?><?php $v17688440650096070881loop->first = ($v17688440650096070881incr == 0); $v17688440650096070881loop->index = $v17688440650096070881incr + 1; $v17688440650096070881loop->index0 = $v17688440650096070881incr; $v17688440650096070881loop->revindex = $v17688440650096070881loop->length - $v17688440650096070881incr; $v17688440650096070881loop->revindex0 = $v17688440650096070881loop->length - ($v17688440650096070881incr + 1); $v17688440650096070881loop->last = ($v17688440650096070881incr == ($v17688440650096070881loop->length - 1)); ?>
		<?= $attribute ?><?php if (($value != '')) { ?>
			="<?= $value ?>"<?php } ?>
		<?= ' ' ?><?php $v17688440650096070881incr++; } ?><?php }; $this->_macros['attributes'] = \Closure::bind($this->_macros['attributes'], $this); ?><?php $this->_macros['schema'] = function($__p = null) { if (isset($__p[0])) { $data = $__p[0]; } else { if (isset($__p["data"])) { $data = $__p["data"]; } else {  throw new \Phalcon\Mvc\View\Exception("Macro 'schema' was called without parameter: data");  } }  ?>
	<<?= $data->tag ?>  <?php if (isset($data->attributes)) { ?> <?= $this->callMacro('attributes', [$data->attributes]) ?> <?php } ?> >
	<?php if (isset($data->text)) { ?>
		<?= $data->text ?>
	<?php } ?>
	<?php if (isset($data->items)) { ?><?php $v17688440650096070881iterator = $data->items; $v17688440650096070881incr = 0; $v17688440650096070881loop = new stdClass(); $v17688440650096070881loop->self = &$v17688440650096070881loop; $v17688440650096070881loop->length = count($v17688440650096070881iterator); $v17688440650096070881loop->index = 1; $v17688440650096070881loop->index0 = 1; $v17688440650096070881loop->revindex = $v17688440650096070881loop->length; $v17688440650096070881loop->revindex0 = $v17688440650096070881loop->length - 1; ?><?php foreach ($v17688440650096070881iterator as $item) { ?><?php $v17688440650096070881loop->first = ($v17688440650096070881incr == 0); $v17688440650096070881loop->index = $v17688440650096070881incr + 1; $v17688440650096070881loop->index0 = $v17688440650096070881incr; $v17688440650096070881loop->revindex = $v17688440650096070881loop->length - $v17688440650096070881incr; $v17688440650096070881loop->revindex0 = $v17688440650096070881loop->length - ($v17688440650096070881incr + 1); $v17688440650096070881loop->last = ($v17688440650096070881incr == ($v17688440650096070881loop->length - 1)); ?>
			<?= $this->callMacro('schema', [$item]) . ' ' ?><?php $v17688440650096070881incr++; } ?>
	<?php } ?>
...
<div class="upperfooter">
    <div class="container">
        <div class="parks">
            <?php $v17688440650096070881iterator = $g->footer->logos; $v17688440650096070881incr = 0; $v17688440650096070881loop = new stdClass(); $v17688440650096070881loop->self = &$v17688440650096070881loop; $v17688440650096070881loop->length = count($v17688440650096070881iterator); $v17688440650096070881loop->index = 1; $v17688440650096070881loop->index0 = 1; $v17688440650096070881loop->revindex = $v17688440650096070881loop->length; $v17688440650096070881loop->revindex0 = $v17688440650096070881loop->length - 1; ?><?php foreach ($v17688440650096070881iterator as $logo) { ?><?php $v17688440650096070881loop->first = ($v17688440650096070881incr == 0); $v17688440650096070881loop->index = $v17688440650096070881incr + 1; $v17688440650096070881loop->index0 = $v17688440650096070881incr; $v17688440650096070881loop->revindex = $v17688440650096070881loop->length - $v17688440650096070881incr; $v17688440650096070881loop->revindex0 = $v17688440650096070881loop->length - ($v17688440650096070881incr + 1); $v17688440650096070881loop->last = ($v17688440650096070881incr == ($v17688440650096070881loop->length - 1)); ?>
        ...
        <?php if (!$desktop) { ?>
            <div class="social u-cf">
                <ul class="nav nav--inline nav-icon">
                    <?php $v17688440650096070881iterator = $g->social; $v17688440650096070881incr = 0; $v17688440650096070881loop = new stdClass(); $v17688440650096070881loop->self = &$v17688440650096070881loop; $v17688440650096070881loop->length = count($v17688440650096070881iterator); $v17688440650096070881loop->index = 1; $v17688440650096070881loop->index0 = 1; $v17688440650096070881loop->revindex = $v17688440650096070881loop->length; $v17688440650096070881loop->revindex0 = $v17688440650096070881loop->length - 1; ?><?php foreach ($v17688440650096070881iterator as $social) { ?><?php $v17688440650096070881loop->first = ($v17688440650096070881incr == 0); $v17688440650096070881loop->index = $v17688440650096070881incr + 1; $v17688440650096070881loop->index0 = $v17688440650096070881incr; $v17688440650096070881loop->revindex = $v17688440650096070881loop->length - $v17688440650096070881incr; $v17688440650096070881loop->revindex0 = $v17688440650096070881loop->length - ($v17688440650096070881incr + 1); $v17688440650096070881loop->last = ($v17688440650096070881incr == ($v17688440650096070881loop->length - 1)); ?>
            ...
            <div class="accordion--item is_close">
                ...
                <div class="accordion-content">
                    <div class="flex--wrap" data-items="<?php if ($mobile) { ?>2<?php } else { ?>3<?php } ?>">
                        <?php $v17688440650096070881iterator = $g->footer->superior->principal; $v17688440650096070881incr = 0; $v17688440650096070881loop = new stdClass(); $v17688440650096070881loop->self = &$v17688440650096070881loop; $v17688440650096070881loop->length = count($v17688440650096070881iterator); $v17688440650096070881loop->index = 1; $v17688440650096070881loop->index0 = 1; $v17688440650096070881loop->revindex = $v17688440650096070881loop->length; $v17688440650096070881loop->revindex0 = $v17688440650096070881loop->length - 1; ?><?php foreach ($v17688440650096070881iterator as $seccion) { ?><?php $v17688440650096070881loop->first = ($v17688440650096070881incr == 0); $v17688440650096070881loop->index = $v17688440650096070881incr + 1; $v17688440650096070881loop->index0 = $v17688440650096070881incr; $v17688440650096070881loop->revindex = $v17688440650096070881loop->length - $v17688440650096070881incr; $v17688440650096070881loop->revindex0 = $v17688440650096070881loop->length - ($v17688440650096070881incr + 1); $v17688440650096070881loop->last = ($v17688440650096070881incr == ($v17688440650096070881loop->length - 1)); ?>
                        <div class="flex--item">
                            <h5><?= $seccion->title ?></h5>
                    ...
                    <ul class="list list-columns list-bars <?= ($mobile ? 'list-mobile' : '') ?>">
                        <?php $v17688440650096070881iterator = $g->footer->superior->secundario; $v17688440650096070881incr = 0; $v17688440650096070881loop = new stdClass(); $v17688440650096070881loop->self = &$v17688440650096070881loop; $v17688440650096070881loop->length = count($v17688440650096070881iterator); $v17688440650096070881loop->index = 1; $v17688440650096070881loop->index0 = 1; $v17688440650096070881loop->revindex = $v17688440650096070881loop->length; $v17688440650096070881loop->revindex0 = $v17688440650096070881loop->length - 1; ?><?php foreach ($v17688440650096070881iterator as $link) { ?><?php $v17688440650096070881loop->first = ($v17688440650096070881incr == 0); $v17688440650096070881loop->index = $v17688440650096070881incr + 1; $v17688440650096070881loop->index0 = $v17688440650096070881incr; $v17688440650096070881loop->revindex = $v17688440650096070881loop->length - $v17688440650096070881incr; $v17688440650096070881loop->revindex0 = $v17688440650096070881loop->length - ($v17688440650096070881incr + 1); $v17688440650096070881loop->last = ($v17688440650096070881incr == ($v17688440650096070881loop->length - 1)); ?>
                            <li>
            ...
            <div class="accordion--item is_close">
                ...
                <div class="accordion-content">
                    ...
                    <ul class="list list-columns phones" data-column="3">
                        <?php $v17688440650096070881iterator = $g->header->atencion->sub; $v17688440650096070881incr = 0; $v17688440650096070881loop = new stdClass(); $v17688440650096070881loop->self = &$v17688440650096070881loop; $v17688440650096070881loop->length = count($v17688440650096070881iterator); $v17688440650096070881loop->index = 1; $v17688440650096070881loop->index0 = 1; $v17688440650096070881loop->revindex = $v17688440650096070881loop->length; $v17688440650096070881loop->revindex0 = $v17688440650096070881loop->length - 1; ?><?php foreach ($v17688440650096070881iterator as $s) { ?><?php $v17688440650096070881loop->first = ($v17688440650096070881incr == 0); $v17688440650096070881loop->index = $v17688440650096070881incr + 1; $v17688440650096070881loop->index0 = $v17688440650096070881incr; $v17688440650096070881loop->revindex = $v17688440650096070881loop->length - $v17688440650096070881incr; $v17688440650096070881loop->revindex0 = $v17688440650096070881loop->length - ($v17688440650096070881incr + 1); $v17688440650096070881loop->last = ($v17688440650096070881incr == ($v17688440650096070881loop->length - 1)); ?>
