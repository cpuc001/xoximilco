    ...
    <div class="block block--faqs row">
        <div class="one-third column text--align-left topics" id="topicos">
            <ul class="list list--block">
                <?php $v107840093793200236491iterator = $t->preguntas->items; $v107840093793200236491incr = 0; $v107840093793200236491loop = new stdClass(); $v107840093793200236491loop->self = &$v107840093793200236491loop; $v107840093793200236491loop->length = count($v107840093793200236491iterator); $v107840093793200236491loop->index = 1; $v107840093793200236491loop->index0 = 1; $v107840093793200236491loop->revindex = $v107840093793200236491loop->length; $v107840093793200236491loop->revindex0 = $v107840093793200236491loop->length - 1; ?><?php foreach ($v107840093793200236491iterator as $tema => $contenido) { ?><?php $v107840093793200236491loop->first = ($v107840093793200236491incr == 0); $v107840093793200236491loop->index = $v107840093793200236491incr + 1; $v107840093793200236491loop->index0 = $v107840093793200236491incr; $v107840093793200236491loop->revindex = $v107840093793200236491loop->length - $v107840093793200236491incr; $v107840093793200236491loop->revindex0 = $v107840093793200236491loop->length - ($v107840093793200236491incr + 1); $v107840093793200236491loop->last = ($v107840093793200236491incr == ($v107840093793200236491loop->length - 1)); ?>
                    <li> <a href="#preguntas<?= $v107840093793200236491loop->index ?>" class="menu-tema"><?= $tema ?><i class="icon icon-angle-right"></i></a></li>
                <?php $v107840093793200236491incr++; } ?>
            </ul>
        </div>
        <div class="two-thirds column text--align-left preguntas" id="preguntas">
            ...
            <ul class="list list--block">
                <?php $parent = 1; ?>
                <?php $v107840093793200236491iterator = $t->preguntas->items; $v107840093793200236491incr = 0; $v107840093793200236491loop = new stdClass(); $v107840093793200236491loop->self = &$v107840093793200236491loop; $v107840093793200236491loop->length = count($v107840093793200236491iterator); $v107840093793200236491loop->index = 1; $v107840093793200236491loop->index0 = 1; $v107840093793200236491loop->revindex = $v107840093793200236491loop->length; $v107840093793200236491loop->revindex0 = $v107840093793200236491loop->length - 1; ?><?php foreach ($v107840093793200236491iterator as $pregs) { ?><?php $v107840093793200236491loop->first = ($v107840093793200236491incr == 0); $v107840093793200236491loop->index = $v107840093793200236491incr + 1; $v107840093793200236491loop->index0 = $v107840093793200236491incr; $v107840093793200236491loop->revindex = $v107840093793200236491loop->length - $v107840093793200236491incr; $v107840093793200236491loop->revindex0 = $v107840093793200236491loop->length - ($v107840093793200236491incr + 1); $v107840093793200236491loop->last = ($v107840093793200236491incr == ($v107840093793200236491loop->length - 1)); ?>
                    <li id="preguntas<?= $v107840093793200236491loop->index ?>" class="menu-preguntas">
                        <ul>
                        <?php $v107840093793200236492iterator = $pregs; $v107840093793200236492incr = 0; $v107840093793200236492loop = new stdClass(); $v107840093793200236492loop->self = &$v107840093793200236492loop; $v107840093793200236492loop->length = count($v107840093793200236492iterator); $v107840093793200236492loop->index = 1; $v107840093793200236492loop->index0 = 1; $v107840093793200236492loop->revindex = $v107840093793200236492loop->length; $v107840093793200236492loop->revindex0 = $v107840093793200236492loop->length - 1; ?><?php foreach ($v107840093793200236492iterator as $pregunta) { ?><?php $v107840093793200236492loop->first = ($v107840093793200236492incr == 0); $v107840093793200236492loop->index = $v107840093793200236492incr + 1; $v107840093793200236492loop->index0 = $v107840093793200236492incr; $v107840093793200236492loop->revindex = $v107840093793200236492loop->length - $v107840093793200236492incr; $v107840093793200236492loop->revindex0 = $v107840093793200236492loop->length - ($v107840093793200236492incr + 1); $v107840093793200236492loop->last = ($v107840093793200236492incr == ($v107840093793200236492loop->length - 1)); ?>
                            <li>
                                <a class="link-pregunta" href="#pregunta<?= $parent ?>-<?= $v107840093793200236492loop->index ?>" ><?= $pregunta->question ?></a>
                            </li>
                        <?php $v107840093793200236492incr++; } ?>
                        </ul>
                    </li>
                    <?php $parent = $parent + 1; ?>
                <?php $v107840093793200236491incr++; } ?>
...
<?php $this->partial('templates/_molecules/questions', ['preguntas' => $t->preguntas]); ?>
